...
char	**visited_array(t_game *tool)
{
	char	**visited;
...
void	check_all_paths(t_game *tool, int x, int y, char **visited)
{
...
void	free_visited_arr(char **visited, int height)
{
	int	i;
